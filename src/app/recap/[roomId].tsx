...
import RecapMediaView from "../../components/RecapMediaView";
...
const styles = StyleSheet.create({
  ...
  hero: { minHeight: 430, justifyContent: "flex-end", backgroundColor: "#160B20", overflow: "hidden" }, heroShade: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(5,4,11,0.6)" }, backButton: { position: "absolute", top: 54, left: 20, width: 44, height: 44, alignItems: "center", justifyContent: "center", borderRadius: 6, backgroundColor: "rgba(5,4,11,0.72)", borderWidth: 1, borderColor: "rgba(255,255,255,0.14)" }, heroCopy: { padding: 22, paddingBottom: 30 }, eyebrowPink: { color: "#FF63A8", fontSize: 12, fontWeight: "900", letterSpacing: 0.8 }, eyebrowPurple: { color: "#C35DFF", fontSize: 12, fontWeight: "900", letterSpacing: 0.8 }, title: { marginTop: 10, color: "#FFFFFF", fontSize: 40, lineHeight: 45, fontWeight: "900", letterSpacing: 0 }, date: { marginTop: 14, color: "#D1CAD8", fontSize: 14, fontWeight: "700" }, hostedByRow: { alignItems: "center", flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 12 }, hostedByLabel: { color: "#D1CAD8", fontSize: 13, fontWeight: "700" }, hostAvatar: { alignItems: "center", backgroundColor: "#7C3AED", borderColor: "rgba(255,255,255,0.28)", borderRadius: 16, borderWidth: 1, height: 32, justifyContent: "center", overflow: "hidden", width: 32 }, hostAvatarText: { color: "#FFFFFF", fontSize: 10, fontWeight: "900" }, hostNameButton: { maxWidth: 140 }, hostName: { color: "#FFFFFF", fontSize: 13, fontWeight: "900" }, followButton: { backgroundColor: "#EF2F91", borderRadius: 999, paddingHorizontal: 11, paddingVertical: 7 }, followingButton: { backgroundColor: "rgba(255,255,255,0.08)", borderColor: "rgba(255,255,255,0.18)", borderWidth: 1 }, followButtonDisabled: { opacity: 0.6 }, followButtonText: { color: "#FFFFFF", fontSize: 11, fontWeight: "900" }, inlineError: { margin: 20, padding: 14, color: "#FDE68A", backgroundColor: "rgba(120,53,15,0.35)", borderRadius: 6 },
  section: { paddingHorizontal: 20, paddingTop: 38 }, sectionAfterHost: { borderTopColor: "#292330", borderTopWidth: 1, marginTop: 38 }, sectionTitle: { marginTop: 7, color: "#FFFFFF", fontSize: 28, lineHeight: 34, fontWeight: "900", letterSpacing: 0 }, emptyText: { marginTop: 16, color: "#AAA4B8", fontSize: 14, lineHeight: 21 }, memoryGrid: { marginTop: 20, flexDirection: "row", flexWrap: "wrap", gap: 10 }, memoryItem: { width: "48.4%", backgroundColor: "#10101A", borderWidth: 1, borderColor: "#262131", borderRadius: 6, overflow: "hidden" }, memoryMedia: { width: "100%", aspectRatio: 1, backgroundColor: "#09080D" }, memoryImage: { width: "100%", height: "100%" }, videoPlaceholder: { flex: 1, alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#171322" }, videoText: { color: "#D8D2DF", fontSize: 11, fontWeight: "800" }, memoryMeta: { height: 48, flexDirection: "row", alignItems: "center", gap: 8, paddingLeft: 10 }, uploader: { flex: 1, color: "#FFFFFF", fontSize: 12, fontWeight: "800" }, saveButton: { width: 42, height: 46, alignItems: "center", justifyContent: "center", backgroundColor: "#17151E" }, saveButtonActive: { backgroundColor: "#7C3AED" },
  ...
  metrics: { marginTop: 20, flexDirection: "row", flexWrap: "wrap", borderTopWidth: 1, borderLeftWidth: 1, borderColor: "#292330" }, metric: { width: "50%", minHeight: 112, padding: 17, justifyContent: "center", borderRightWidth: 1, borderBottomWidth: 1, borderColor: "#292330", backgroundColor: "#10101A" }, metricValue: { color: "#D8B4FE", fontSize: 29, fontWeight: "900" }, metricLabel: { marginTop: 7, color: "#AAA4B8", fontSize: 12, lineHeight: 17, fontWeight: "700" }, personal: { marginTop: 18, color: "#B8B2C8", fontSize: 14, lineHeight: 21, fontWeight: "700" }, hostMessage: { marginHorizontal: 20, marginTop: 28, borderLeftWidth: 2, borderLeftColor: "#FF63A8", backgroundColor: "#140D19", overflow: "hidden" }, hostMessageCopy: { paddingHorizontal: 20, paddingVertical: 23 }, hostMedia: { borderTopColor: "rgba(255,255,255,0.1)", borderTopWidth: 1 }, hostLabel: { color: "#FF82B8", fontSize: 11, fontWeight: "900", letterSpacing: 0.8 }, hostCopy: { marginTop: 11, color: "#FFFFFF", fontSize: 19, lineHeight: 28, fontWeight: "800" },
});
