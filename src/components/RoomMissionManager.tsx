...
export default function RoomMissionManager({
  ...
  const loadData = useCallback(async () => {
    ...
    setOperations(
      isHost && nextMission && !["connection", "wild_faction", "live_node"].includes(nextMission.mission_type)
...
const styles = StyleSheet.create({
  ...
  endButton: { alignItems: "center", alignSelf: "center", backgroundColor: "rgba(127,29,29,0.22)", borderColor: "rgba(248,113,113,0.45)", borderRadius: 999, borderWidth: 1, marginTop: 13, maxWidth: 320, minHeight: 48, justifyContent: "center", paddingHorizontal: 18, width: "100%" },
  endButtonText: { color: "#FCA5A5", fontWeight: "900" },
  completedListButton: { alignItems: "center", alignSelf: "center", backgroundColor: "rgba(255,255,255,0.035)", borderColor: "rgba(196,181,253,0.4)", borderRadius: 999, borderWidth: 1, marginTop: 12, maxWidth: 320, minHeight: 48, justifyContent: "center", paddingHorizontal: 18, width: "100%" },
  ...
  createButton: { alignItems: "center", alignSelf: "center", backgroundColor: "#7C3AED", borderColor: "#A78BFA", borderRadius: 999, borderWidth: 1, justifyContent: "center", marginTop: 14, maxWidth: 320, minHeight: 48, paddingHorizontal: 18, width: "100%" },
  ...
  cancelButton: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.035)", borderColor: "rgba(255,255,255,0.16)", borderRadius: 999, borderWidth: 1, flexGrow: 1, justifyContent: "center", minHeight: 46, minWidth: 120, paddingHorizontal: 16 },
